<div>
    <center>
        <table>
            ...
            <tr>
                <td>
                    <a class="btn btn-sm btn-outline-danger" onclick="information('Waktu pengembalian BUKU 1x24 jam dari Booking!!!')" href="<?php echo base_url() . 'booking/exportToPdf' . $this->session->userdata('id_user'); ?>"><span class="far fa-lag fa-fw fa-file-pdf"></span>Pdf</a>
                </td>
            </tr>
        </table>
    </center>
