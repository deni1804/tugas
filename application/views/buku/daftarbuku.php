    ...
    <div class="x_panel">
        <div class="x_content">
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-mid-2 col-mid-3">
                        <div class="thumbnail" style="height: 370px;">
                            <img src="<?php echo base_url(); ?>assets/img/upload/<?= $buku->image; ?>" style="max-width:100%; max-height:100%; height:200px; widht:180px">
                            <div class="caption">
                                <h5 class="min-height:30px;"><?= $buku->pengarang ?></h5>
                                <h5><?= $buku->penerbit ?></h5>
